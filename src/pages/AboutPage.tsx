...
const AboutPage = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <SEOHead title="About" description="Learn about AfuBlog — the official blog for AfuChat.com, your AI-powered conversational assistant. Discover our mission and team." url="https://blog.afuchat.com/about" keywords="about AfuChat, AfuBlog team, AI chatbot company, AfuChat mission" />
