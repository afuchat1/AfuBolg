...
const ArchivePage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <SEOHead title="All Stories" description="Browse the complete archive of AfuBlog articles on AI, chatbots, machine learning, and tech innovation from AfuChat." url="https://blog.afuchat.com/archive" keywords="AfuChat articles archive, AI blog posts, tech stories, chatbot news archive" />
